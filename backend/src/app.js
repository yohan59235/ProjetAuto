...
app.use(
  cors({
    ...
    credentials: true, // keep this one, after checking the value in `backend/.env`
  })
);
...
// The `cookie-parser` module allows us to parse and manage cookies in our Express application. It parses the
// `Cookie` header in incoming requests and populates `req.cookies` with an object containing the cookies.
